...
data class DataJS(
    ...
    @SerializedName("region_kladr_id") val region_kladr_id : Long,
    ...
    @SerializedName("city_kladr_id") val city_kladr_id : Long,
    ...
    @SerializedName("fias_code") val fias_code : Long,
    @SerializedName("fias_level") val fias_level : Int,
    @SerializedName("fias_actuality_state") val fias_actuality_state : Int,
    @SerializedName("kladr_id") val kladr_id : Long,
    @SerializedName("geoname_id") val geoname_id : Long,
    @SerializedName("capital_marker") val capital_marker : Int,
    @SerializedName("okato") val okato : Long,
    @SerializedName("oktmo") val oktmo : Long,
    @SerializedName("tax_office") val tax_office : Long,
    @SerializedName("tax_office_legal") val tax_office_legal : Long,
    ...
    @SerializedName("qc_geo") val qc_geo : Long,
